...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source RELAX - اهلا بك في سورس ديف ريلاكس ~"
...
echo -e "---------------------------------------------"
echo -e "| ____      _|"
echo -e "||  _ \ ___| | __ ___  __|"
echo -e "|| |_) / _ \ |/ _` \ \/ /|"
echo -e "| |  _ <  __/ | (_| |>  <|"
echo -e "||_| \_\___|_|\__,_/_/\_\|"
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By (HDR) @NNUUU.--|"
echo -e "|  This Is The Source Channel @Vc33h .   |"
echo -e "|               - RELAX -                 |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
