...
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌔︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'Vc33h')..')'..' ❩\n⌔︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrali == "مميز" and VipMem(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌔︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'Vc33h')..')'..' ❩\n⌔︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
Dev_Ali(msg.sender_user_id_, msg.id_, 1, '⌔︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "Vc33h")..')', 1, 'md') 
...
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌔︙Channel ↬ [@Vc33h]', 1, 'md')    
end 
--     Source ReLaX     --
if Sudo(msg) then 
