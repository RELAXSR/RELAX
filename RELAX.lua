...
https.request("https://apiabs.ml/Api/David/index.php?Get=David&DevId="..DevRio:get(Server.."IdRELAX").."&TokenBot="..DevRio:get(Server.."TokenRELAX").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
