...
if text == "↫ بوت الكت ᥀" and ChCheck(msg) or text == "بوت الكت" and ChCheck(msg) or text == "بوت كت" and ChCheck(msg) then local inline = {{{text="اضغط هنا",url="https://t.me/Ra_4Bot"}}} SendInline(msg.chat_id_,'*᥀︙اضغط للحصول على بوت الكت*',nil,inline) return false end
if text == "↫ بوت الزخرفه ᥀" and ChCheck(msg) or text == "بوت الزخرفه" and ChCheck(msg) or text == "بوت زخرفه" and ChCheck(msg) then local inline = {{{text="اضغط هنا",url="https://t.me/Yo_5BOT"}}} SendInline(msg.chat_id_,'*᥀︙اضغط للحصول على بوت الزخرفه*',nil,inline) return false end
...
if DevRio:sismember(RELAX..'Ali:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(RELAX..'Rio:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(RELAX..'Rio:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevRio:sismember(RELAX..'Rio:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevRio:sismember(RELAX..'Rio:VipAll:',result.id_) then
...
DevRio:srem(RELAX..'Rio:ManagerAll:', result.id_)
DevRio:srem(RELAX..'Rio:AdminAll:', result.id_)
DevRio:srem(RELAX..'Rio:VipAll:', result.id_)
...
DevRio:srem(RELAX..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
DevRio:srem(RELAX..'Rio:Cleaner:'..msg.chat_id_, result.id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'aliconstructor' then
DevRio:srem(RELAX..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:srem(RELAX..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:srem(RELAX..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:srem(RELAX..'Rio:Constructor:'..msg.chat_id_,result.id_)
