...
data,res = https.request("https://apiabs.ml/Api/RELAX/index.php?Ban=RELAX&Info&Id="..DevId)
if res == 200 then
...
local url,res = https.request('https://ccccxcc.ml/RELAX/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.ChatMember.RELAX ~= true then
Var = false
Text = "*᥀︙عذرا لاتستطيع استخدام البوت !\n᥀︙عليك الاشتراك في قناة السورس اولا :*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="᥀ 𝗗𝗮𝘃𝗶𝗱 : 𝗧𝗲𝗮𝗠 .",url="t.me/Vc33h"}}} 
...
if text and (text == "متحركه" or text == "↫ متحركه ᥀") and not DevRio:get(RELAX..'Rio:gif:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text and (text == "ميمز" or text == "↫ ميمز ᥀") and not DevRio:get(RELAX..'Rio:memz:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text and (text == "غنيلي" or text == "↫ غنيلي ᥀") and not DevRio:get(RELAX..'Rio:Audios:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text and (text == "اغنيه" or text == "↫ اغنيه ᥀" or text == "اغاني") and not DevRio:get(RELAX..'Rio:mp3:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text and (text == "ريمكس" or text == "↫ ريمكس ᥀") and not DevRio:get(RELAX..'Rio:Remix:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text and (text == "صوره" or text == "↫ صوره ᥀") and not DevRio:get(RELAX..'Rio:Photo:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text and (text == "انمي" or text == "↫ انمي ᥀") and not DevRio:get(RELAX..'Rio:Anime:Rio'..msg.chat_id_) and SourceCh(msg) then
...
if text and (text == "مسلسل" or text == "↫ مسلسل ᥀") and not DevRio:get(RELAX..'Rio:Series:Rio'..msg.chat_id_) and SourceCh(msg) then
