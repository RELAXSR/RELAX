...
local url,res = https.request('https://ccccxcc.ml/RELAX/ChCheck.php?id='..msg.sender_user_id_)
...
if text and (text == "متحركه" or text == "↫ متحركه ᥀") and not DevRio:get(RELAX..'Rio:gif:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "ميمز" or text == "↫ ميمز ᥀") and not DevRio:get(RELAX..'Rio:memz:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "غنيلي" or text == "↫ غنيلي ᥀") and not DevRio:get(RELAX..'Rio:Audios:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "اغنيه" or text == "↫ اغنيه ᥀" or text == "اغاني") and not DevRio:get(RELAX..'Rio:mp3:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "ريمكس" or text == "↫ ريمكس ᥀") and not DevRio:get(RELAX..'Rio:Remix:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "صوره" or text == "↫ صوره ᥀") and not DevRio:get(RELAX..'Rio:Photo:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "انمي" or text == "↫ انمي ᥀") and not DevRio:get(RELAX..'Rio:Anime:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "مسلسل" or text == "↫ مسلسل ᥀") and not DevRio:get(RELAX..'Rio:Series:Rio'..msg.chat_id_) and ChCheck(msg) then
