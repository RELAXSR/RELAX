------------------------------------------------
-- This Source Was Developed By (Rio) @NNUUU.--
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,833156404,1957577169,1923530576}
RELAX = Config.RELAX
TokenBot = Config.TokenBot
NameBot = (DevRio:get(RELAX..'Rio:NameBot') or 'ديفد')
--     Source RELAX     --
...
if text and text:match('^'..(DevRio:get(RELAX..'Rio:NameBot') or "ديفد")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(RELAX..'Rio:NameBot') or "ديفد")..' ','')
end
...
{{text="᥀ السورس .",url="https://t.me/Vc33h"},{text="᥀ لتنصيب بوت .",url="https://t.me/NNUUU"}},{{text="᥀ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
...
local BotName = (DevRio:get(RELAX.."Rio:NameBot") or 'ديفد')
...
if text and text == (DevRio:get(RELAX..'Rio:NameBot') or 'ديفد') then 
NameBot = (DevRio:get(RELAX..'Rio:NameBot') or 'ديفد')
...
--     Source RELAX     --
iif text == "السورس" or text == "سورس" then 
Text = [[
Welcome To Source
...
DevRio:set(RELAX..'Rio:NameBot',(DevRio:get(RELAX..'Name:Bot') or 'ديفد'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
